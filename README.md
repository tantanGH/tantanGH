...
以下のように何も引数をつけずに実行すると、1024x1024x65536モードのグラフィック画面を再表示できます。

    GJ0.X

以下のように何か引数をつけて実行すると、1024x1024x65536モードのグラフィック画面のVRAMをクリアします。
...
これはX680x0用ソフトウェアではありませんが、X680x0上で表示できる16色または256色のMAG形式画像ファイルを生成できるコンバータです。
